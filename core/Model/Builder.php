...
class Builder
{
    ...
    public function get()
    {
        ...
        $rows = $this->connection->query($sql)->fetchAll($this->fetchType);

        if (! $this->model) return $rows;
    ...
    public function first()
    {
        ...
        $row = $this->connection->query($sql)->fetch($this->fetchType);
